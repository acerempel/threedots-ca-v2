    ...
    content:
      -
        ...
        content:
          -
            type: text
            text: "Ordinarily I find Three Dots' analysis of contemporary issues to be entirely without par in respect of its cutting insights. Never have I failed to be persuaded by your columnists' flowing paragraphs. Never, that is, until last week, when you published the article titled: \"On electoral reform: The post's best-before date is long past\". I disagree vehemently with that article's completely baseless and unfounded assertion that ..."
  -
    type: paragraph
    content:
      -
        type: text
        text: 'This letter has caused the editorial team at Three Dots no small amount of perplexity. We have never published an article with the title "On electoral reform: The post''s best-before date is long past" or any similar title. (At the very least, we would have called it "'
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' electoral reform: ...", as our internal style guide requires.) Moreover, we have never covered the topic of electoral reform at all. Anyone may easily search our archives and confirm this. On the whole, we avoid contemporary issues of general interest, preferring instead to focus on the obscure, irrelevant, and absurd. Yet it would be surprising if our letter-writer had confused us with some other publication, since our name is so distinctive, our circulation so narrow. We also cannot find any article in any other publication with the title our esteemed reader cites.'
  -
    type: paragraph
    content:
      -
